...
import { useSignInAnonymous, useAuthStore } from '../../src/features/auth';
  ...
  const handleGetStarted = async () => {
    if (!session) {
      signIn.mutate(undefined, {
        onSuccess: () => router.push('/onboarding/vibe'),
        onError: (err) => console.error('[LEVEL] Anon sign-in failed:', err),
      });
    } else {
      ...
      <View style={styles.content}>
        <View style={styles.hero}>
          ...
          <Text style={styles.description}>
            Complete daily quests, prove it with a photo, and level up your life
            — one day at a time.
          </Text>
        </View>
